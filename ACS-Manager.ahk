...
CrtDate:=SubStr(CrtDate,7, 2) "." SubStr(CrtDate,5,2) "." SubStr(CrtDate,1,4)
	, global script := { base : script
		...
		,vfile_raw	 : "https://raw.githubusercontent.com/Gewerd-Strauss/ACS-Manager/main/version.ini"
		,vfile 		 : "https://raw.githubusercontent.com/Gewerd-Strauss/ACS-Manager/main/version.ini"
		...
		,Data_vfile_raw : "https://raw.githubusercontent.com/Gewerd-Strauss/ACS-Manager/main/dataversion.ini"
		,Data_vfile	 : "https://raw.githubusercontent.com/Gewerd-Strauss/ACS-Manager/main/dataversion.ini"
...
fSearchSnippetsEnter(SnippetsStructure,References,DirectoryPath,SearchHistory)
{
	...
	;; DONT FORGET TO ADD NEW COMMANDS TO 'GuiCommands' at the start of the script
...
ACS_Obj2Str(Obj,FullPath:=1,BottomBlank:=0)
{
	static String,Blank
	if(FullPath=1)
	String:=FullPath:=Blank:=""
	if(IsObject(Obj)){
		for a,b in Obj{
			if(IsObject(b))
			ACS_Obj2Str(b,FullPath "." a,BottomBlank)
			else{
				if(BottomBlank=0)
				String.=FullPath "." a " = " b "`n"
				else if(b!="")
